        ...
        <nav className="nav">
            <ul>
                <li className={classes.item}>
                    <svg className="bi bi-person-fill" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor"
                ...
                <li className={classes.item}>
                    <svg className="bi bi-card-heading" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor"
                         xmlns="http://www.w3.org/2000/svg">
                        <path fillRule="evenodd"
                ...
                <li className={classes.item}>
                    <svg className="bi bi-gear-wide" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor"
                         xmlns="http://www.w3.org/2000/svg">
                        <path fillRule="evenodd"
